...
// Source: deps/deepseek_v4/DeepSeek-V4-Pro/inference/kernel.py (`hc_split_sinkhorn_kernel`)
// Shape constants used: hc=4, sinkhorn_iters=20, eps=1e-06.
// `n` (number of tokens) is symbolic.
...
extern "C" __global__ void hc_split_sinkhorn_kernel__kernel(float* __restrict__ comb, const float* __restrict__ hc_base, const float* __restrict__ hc_scale, const float* __restrict__ mixes, float* __restrict__ post, float* __restrict__ pre, int n);
extern "C" __global__ void __launch_bounds__(64, 1) hc_split_sinkhorn_kernel__kernel(float* __restrict__ comb, const float* __restrict__ hc_base, const float* __restrict__ hc_scale, const float* __restrict__ mixes, float* __restrict__ post, float* __restrict__ pre, int n) {
