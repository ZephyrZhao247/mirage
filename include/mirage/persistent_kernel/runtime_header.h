...
enum TaskType {
  ...
  TASK_NVSHMEM_TILE_ALLGATHER = 303,
  TASK_NVSHMEM_REDUCESCATTER_PUT = 304,
  TASK_NVSHMEM_ALLTOALL_PUT = 305,
  TASK_NVSHMEM_BROADCAST_PUT = 306,
  TASK_NVSHMEM_BROADCAST_RECV = 307,
  TASK_NVSHMEM_TILE_BROADCAST = 308,
